        ...
        <article className="form">
            <form className="form__autorization-container">
                ...
                <div className="form__autorization-content">
                    ...
                    <input name="email" className="form__autorization-input" id="email" value="" placeholder="E-mail" />
                    <p className="form__autorization-subtitle">{props.subtitle1}</p>
                    <input name="password" type="password" className="form__autorization-input" id="password" value="" placeholder="Password" />
